...
// Load bar
    ...
    var border = 2;
    var border_color = "rgb(51,239,244)";
    var bar_bg = "rgb(20,20,20)";
    var progress_bg = "rgb(255,255,255)";
// Background
    var window_bgd = "rgb(13,15,26)";
...
// U.r.l. logo (blank "" just skips it from showing)
	...
	_graphics.fillStyle = "rgb(51,239,244)";
	_graphics.font = "40px Arial";
	_graphics.textAlign = "center";
    _graphics.fillText("Asteroid Defender", (_width*0.5), (_height*0.5)-50 );
